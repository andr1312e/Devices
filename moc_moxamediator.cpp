...
void MoxaMediator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MoxaMediator *_t = static_cast<MoxaMediator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MoxaMediator::*)(DevicesMoxaStateMessage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MoxaMediator::ToSendRarmMoxaWorksState)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MoxaMediator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MoxaMediator.data,
      qt_meta_data_MoxaMediator,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *MoxaMediator::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *MoxaMediator::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_MoxaMediator.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int MoxaMediator::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void MoxaMediator::ToSendRarmMoxaWorksState(DevicesMoxaStateMessage & _t1)
{
